...
app-debug:
	pyinstaller --onefile --windowed --icon=icon.ico --add-data="icon.ico;." --add-data="data/haarcascade_frontalface_default.xml;data" --add-data="style/app.qss;style" -n "Sipadu Contonge" main.py --noconfirm
